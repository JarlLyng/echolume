...
private let log = Logger(subsystem: "com.iamjarl.echolume.EcholumeAudioTap", category: "AudioUnitViewController")
...
public class AudioUnitViewController: AUViewController, AUAudioUnitFactory {
	...
	*/
    ...
    private func configureSwiftUIView(audioUnit: AUAudioUnit) {
        ...
        let content = EcholumeAudioTapMainView(parameterTree: observableParameterTree)
