...
struct SetupView: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            // GeometryReader wraps the ScrollView (not the content): it reads the
            // full viewport width for the column breakpoint, while the ScrollView
            // inside still sizes to its content height and scrolls.
