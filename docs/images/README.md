...
## Photo credits (Unsplash — free license, commercial use)
- Club/crowd scenes: Aleksandr Popov, Baptiste Merel, Pim Myten (Unsplash).
Web-optimised copies live here; full-res sources are in `design/photos/`.
